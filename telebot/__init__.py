...
# The HerokuPostgreSQL Class Support
class HerokuPostgreSQL:
    """
    The HerokuPostgreSQL class:
    All Methods:
        1 -? is_user -> IsUser
        2 -? add_user -> AddUser
        3 -? remove_user -> RemoveUser
        4 -? get_all_users -> GetAllUsers
    ...
    def IsUser(self, chat_id):
        self.is_user(chat_id=chat_id)

    def AddUser(self, chat_id):
        self.add_user(chat_id=chat_id)

    def RemoveUser(self, chat_id):
        self.remove_user(chat_id=chat_id)
