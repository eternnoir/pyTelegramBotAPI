...
async def hello_handler_ignore_case(message: Message):
...
async def contains_handler_ignore_case(message: Message):
    await bot.send_message(message.chat.id, message.text + " ignore case")
...
async def starts_with_handler_ignore_case(message: Message):
    await bot.send_message(message.chat.id, message.text + " ignore case")
...
async def ends_with_handler_ignore_case(message: Message):
    await bot.send_message(message.chat.id, message.text + " ignore case")


@bot.message_handler(text=TextFilter(equals="/callback"))
async def send_callback(message: Message):
...
async def callback_query_handler_ignore_case(call: CallbackQuery):
    await bot.answer_callback_query(
        call.id, call.data + " ignore case", show_alert=True
    )
...
async def poll_question_handler_ignore_case(poll: Poll):
...
async def multiple_patterns_handler(message: Message):
    await bot.send_message(message.chat.id, message.text)
...
async def multiple_starts_with_handler(message: Message):
    await bot.send_message(message.chat.id, message.text)
...
async def multiple_ends_with_handler(message: Message):
    await bot.send_message(message.chat.id, message.text)
